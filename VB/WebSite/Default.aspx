<%@ Page Language="vb" AutoEventWireup="true" CodeFile="Default.aspx.vb" Inherits="Grid_Editing_EditFormWithSeveralPages_EditFormWithSeveralPages" %>
		...
		<dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="dsSampleDataSource" KeyFieldName="EmployeeID" Width="600px" 
			...
			<Templates>
				<EditForm>
					...
					<asp:Panel ID="pnlEmployeeIDContainer" runat="server" Visible='<%#Not Container.Grid.IsNewRowEditing%>'>
